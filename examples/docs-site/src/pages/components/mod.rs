...
/// Component page router - dispatches to the correct component page based on name
#[component]
#[allow(non_snake_case)]
pub fn ComponentPage(name: String) -> Element {
    match name.as_str() {
        ...
        "slider" => slider::SliderPage(),
        "rate" => rate::RatePage(),
        "image" => image::ImagePage(),
        "space" => space::SpacePage(),
        "segmented" => segmented::SegmentedPage(),
        "input_number" => input_number::InputNumberPage(),
        "upload" => upload::UploadPage(),
        "carousel" => carousel::CarouselPage(),
        "form" => form::FormPage(),
        "tree" => tree::TreePage(),
        "date_picker" => date_picker::DatePickerPage(),
